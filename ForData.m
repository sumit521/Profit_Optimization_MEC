...
for i = 1:50
    ...
    data_set{q-1,i}=[nnz(permitted_ues),sol(i).N_new,profit(i),sol(i).b_sum,sum(sol(i).cm),latency_check,sol(i).ues_served,sol(i).mean_e,sol(i).total_outdata];
end
...
table2.Properties.VariableNames = {'permitted_ues','N','profit','frac_RRH1','frac_RRH2','frac_RRH3','frac_RRH4','frac_RRH5','frac_RRH6','frac_RRH7','frac_RRH8',...
    ...
    ,'eff_RRH1','eff_RRH2','eff_RRH3','eff_RRH4','eff_RRH5','eff_RRH6','eff_RRH7','eff_RRH8','eff_RRH9','eff_RRH10','total_out_data'};
